...
licensed under GNU GPL v3 or later. Each generated Windows dependency bundle contains a
...
upstream application. Before publishing, run the `Build Viewer lib dependency branch`
workflow; it rejects an unrecognised Python dependency licence and records the
resolved package set under `lib/licenses/`.
